        ...
        <div style="margin-top:6%;">
            <div class="dl-container">
                <div class="header-content">
                    <p class="subtitle" style="color: white; font-family: Rany-Bold;">Brand Identity-Portfolio</p>
                ...
                <div class="wpo-section-title-s2">
                    <div class="row align-items-center">
                        <div class="col-lg-4 col-12">
                            <div class="title">
                                <h2>Recent Work.</h2>
                                <p>Recent Projects Portfolio Brand Identity</p>
                            </div>
                        </div>
                ...
                <div class="wpo-project-wrap wpo-project-slide owl-carousel">
                    <div class="wpo-project-item">
                        <div class="wpo-project-img">
                            <img src="assets1/images/project/djjlaw-id352.jpg" alt="">
                        </div>
                        <div class="wpo-project-text">
                            <h2><a href="#">DJJLaw - Dohm Jaffer Jeraj</a></h2>
                            <span>Brand Identity / Design</span>
                        </div>
                    </div>
                    <div class="wpo-project-item">
                        <div class="wpo-project-img">
                            <img src="assets1/images/project/tires352.png" alt="">
                        </div>
                        <div class="wpo-project-text">
                            <h2><a href="#">JGB - JGB Tires Sales</a></h2>
                            <span>Brand Identity / Design</span>
                        </div>
                    </div>
                    <div class="wpo-project-item">
                        <div class="wpo-project-img">
                            <img src="assets1/images/project/halls352.jpg" alt="">
                        </div>
                        <div class="wpo-project-text">
                            <h2><a href="#">CBHalls - CelebrationHalls Branding</a></h2>
                           <span>Brand Identity / Design</span>
                        </div>
                    </div>
                    <div class="wpo-project-item">

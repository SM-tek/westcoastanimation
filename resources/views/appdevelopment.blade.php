        ...
        <div style="margin-top:6%;">
            <div class="dl-container">
                <div class="header-content">
                    <p class="subtitle" style="color: white; font-family: Rany-Bold;">App Development-Portfolio</p>
                ...
                <div class="wpo-section-title-s2">
                    <div class="row align-items-center">
                        <div class="col-lg-4 col-12">
                            <div class="title">
                                <h2>Recent Work.</h2>
                                <p>Recent Projects Portfolio App Development</p>
                            </div>
                        </div>
                ...
                <div class="wpo-project-wrap wpo-project-slide owl-carousel">
                    <div class="wpo-project-item">
                        <div class="wpo-project-img">
                            <img src="assets1/images/project/tapnstyle352.png" alt="">
                        </div>
                        <div class="wpo-project-text">
                            <h2><a href="#">TapNStyle - Beauty Artist Directory</a></h2>
                            <span>App Development / Business</span>
                        </div>
                    </div>
                    <div class="wpo-project-item">
                        <div class="wpo-project-img">
                            <img src="assets1/images/project/selebritybeauty352.jpg" alt="">
                        </div>
                        <div class="wpo-project-text">
                            <h2><a href="#">Selebriti Beauty - Selebriti Mobile Spa</a></h2>
                            <span>App Development / Business</span>
                        </div>
                    </div>
                    <div class="wpo-project-item">
                        <div class="wpo-project-img">
                            <img src="assets1/images/project/beautysalon352.jpg" alt="">
                        </div>
                        <div class="wpo-project-text">
                            <h2><a href="#">Beauty Parlours - Beauty Salon App</a></h2>
                            <span>App Development / Business</span>
                        </div>
                    </div>
                    <div class="wpo-project-item">

...
<!-- End of  Zendesk Widget script -->
       ...
       <meta name="keywords" content="westcoast animations, westcoast, animations, animation, , westcoast animation, westcoast logo, westcoast animation style, illustrations, Portfolio, design, creative">
        ...
        <!-- Title -->
        <title>Portfolio - Westcoast Animations</title>
        <!-- Favicon -->
...
-->
 ...
 <br>
                                                                                     <div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/717044955?h=e029550395" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
<br>
                                                                                     <div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/720679012?h=e029550395" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
<br>      
                                                                                     <div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/720624274?h=e029550395" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
<br> 
                                                                                     <div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/715242836?h=2a981d9f1b" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
<br> 
                                                                                     <div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/717024745?h=5b1d65b4a0" style="position:absolute;top:0;left:0;width:100%;height:100%;" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
<br> 
...
-->
                    ...
                    <div class="portfolio-content">
                       ...
                       <!--     <div class="grid__item pen product col-12 col-md-6">
                          ...
                          <!-- <div class="grid__item pen product col-12 col-md-6" style="flex: 0 0 53% !important;">
...
<!--
                            ...
                            <div class="grid__item pen product col-12 col-md-6">
                                <a href="{{route("commercial")}}">
                                   ...
                                   <video width="100%" height="100%" style="object-fit: fill;" controls="" autoplay="" loop="" muted="">
                                        <source src="assets/images/slider/FINAL VIDEO1.mp4" type="video/mp4">
                                        <source src="assets/images/slider/FINAL VIDEO1.mp4" type="video/ogg">
                                        Your browser does not support the video tag.
                                      </video> 
                                </a>
                                <div class="item-info">
                                    <h5>Commercial</h5>
                                    <a class="cursor-alter" href="{{route("commercial")}}">
                                        <h4>Video</h4>
                                    </a>
                                </div>
                            </div>  

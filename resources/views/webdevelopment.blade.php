        ...
        <div style="margin-top:6%;">
            <div class="dl-container">
                <div class="header-content">
                    <p class="subtitle" style="color: white; font-family: Rany-Bold;">Web Development-Portfolio</p>
        ...
        <div class="content">
            ...
            <div class="container">
                <div class="wpo-section-title-s2">
                    <div class="row align-items-center">
                        <div class="col-lg-4 col-12">
                            <div class="title">
                                <h2>Recent Work.</h2>
                                <p>Recent Projects Portfolio Web Page Design</p>
                            </div>
                        </div>
                ...
                <div class="wpo-project-wrap wpo-project-slide owl-carousel">
                    ...
                    <div class="wpo-project-item">
                        <div class="wpo-project-img">
                            <img src="assets1/images/project/LythRk352.jpg" alt="">
                        </div>
                        <div class="wpo-project-text">
                            <h2><a href="#">Nixonstix - Vape Selling Brand</a></h2>
                            <span>Web Development / Business</span>
                        </div>
                    </div>
                    <div class="wpo-project-item">
                        <div class="wpo-project-img">
                            <img src="assets1/images/project/XrSwmx352.jpg" alt="">
                        </div>
                        <div class="wpo-project-text">
                            <h2><a href="#">Bear&Co - Construction Company Website</a></h2>
                            <span>Web Development / Business</span>
                        </div>
                    </div>
                    <div class="wpo-project-item">

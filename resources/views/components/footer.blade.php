            ...
            <div class="row" style="margin-top:6%">
                <div class="col-sm-6">
                    <div class="footer-widget">
                        <h6 class="widget-title" style="color:white; margin-right:48%">Services</h6>
                ...
                <div class="col-sm-3">
                    <div class="footer-widget" id="ft">
                        <h6 class="widget-title" id="ft1" style="color:white; margin-right:-51%; margin-left:-157%" >Resourses</h6>
                        <div class="footer-menu-link" >
                            <ul class="list-unstyled">
                ...
                <div class="col-sm-3">
                    <div class="footer-widget">
                        <h6 class="widget-title" id="ft3" style="color:white; margin-left:-18%">Support</h6>
                        <div class="footer-menu-link">

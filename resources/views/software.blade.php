        ...
        <div style="margin-top:10%;" >
            <div class="dl-container">
                <div class="header-content">
                    <p class="subtitle" style="color: white; font-family: Rany-Bold;">Software Development-Portfolio</p>
                ...
                <div class="wpo-section-title-s2">
                    <div class="row align-items-center">
                        <div class="col-lg-4 col-12">
                            <div class="title">
                                <h2>Recent Work.</h2>
                                <p>Recent Projects Portfolio Software Development</p>
                            </div>
                        </div>
                ...
                <div class="wpo-project-wrap wpo-project-slide owl-carousel">
                    <div class="wpo-project-item">
                        <div class="wpo-project-img">
                            <img src="assets1/images/project/software1352.jpg" alt="">
                        </div>
                        <div class="wpo-project-text">
                            <h2><a href="#">Development Platform - Software Development Platform</a></h2>
                            <span>Development / Software</span>
                        </div>
                    </div>
                    <div class="wpo-project-item">
                        <div class="wpo-project-img">
                            <img src="assets1/images/project/software2352.jpg" alt="">
                        </div>
                        <div class="wpo-project-text">
                            <h2><a href="#">Software Analytics - Analytics Software Development</a></h2>
                            <span>Development / Software</span>
                        </div>
                    </div>
                    <div class="wpo-project-item">
                        <div class="wpo-project-img">
                            <img src="assets1/images/project/software3352.jpg" alt="">
                        </div>
                        <div class="wpo-project-text">
                            <h2><a href="#">Wavelength - Software Development</a></h2>
                           <span>Development / Software</span>
                        </div>
                    </div>
                    <div class="wpo-project-item">

        ...
        <div style="margin-top:6%;" >
            <div class="dl-container">
                <div class="header-content">
                    <p class="subtitle" style="color: white; font-family: Rany-Bold;">UI/UX-Portfolio</p>
                ...
                <div class="wpo-section-title-s2">
                    <div class="row align-items-center">
                        <div class="col-lg-4 col-12">
                            <div class="title">
                                <h2>Recent Work.</h2>
                                <p>Recent Projects Portfolio UI/UX</p>
                            </div>
                        </div>
                ...
                <div class="wpo-project-wrap wpo-project-slide owl-carousel">
                    <div class="wpo-project-item">
                        <div class="wpo-project-img">
                            <img src="assets1/images/project/food352.jpg" alt="">
                        </div>
                        <div class="wpo-project-text">
                            <h2><a href="#">Food UI/UX - Food Restaurant Design</a></h2>
                            <span>UI/UX / Design</span>
                        </div>
                    </div>
                    <div class="wpo-project-item">
                        <div class="wpo-project-img">
                            <img src="assets1/images/project/digitalagency352.jpg" alt="">
                        </div>
                        <div class="wpo-project-text">
                            <h2><a href="#">Digital Agency UI - Digital Services UI</a></h2>
                            <span>UI/UX / Design</span>
                        </div>
                    </div>
                    <div class="wpo-project-item">
                        <div class="wpo-project-img">
                            <img src="assets1/images/project/marketing352.jpg" alt="">
                        </div>
                        <div class="wpo-project-text">
                            <h2><a href="#">GrowFast - Digital Marketing Agency</a></h2>
                           <span>UI/UX / Design</span>
                        </div>
                    </div>
                    <div class="wpo-project-item">

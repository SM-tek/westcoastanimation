...
">
    ...
    <script type="text/javascript" src="//widget.trustpilot.com/bootstrap/v5/tp.widget.bootstrap.min.js" async></script>
      ...
      <link href="servicesbox/css/blueket.plugin.css" rel="stylesheet">
...
.bkbg0 {
    background: linear-gradient(90deg, #9C2376 0%, #4F1D70 80%);
}
...
<a href='https://www.bark.com/en/us/company/westcoast-studios/2jgl4/' id="barkpro" target='_blank' class='bark-widget' style="margin-top: -3% !important ; margin:0 3%;margin-left: -8px !important" data-type='pro' data-id='2jgl4' data-image='medium-navy' data-version='3.0'>Westcoast Studios</a><script type='text/javascript' src='https://d3a1eo0ozlzntn.cloudfront.net/assets/js/frontend-v2/widgets-v2.24a197bed6.v2.js' defer></script>
  ...
  -->
    ...
    <div class="service-row-block bkbg0 wow fadeInUp" data-wow-delay=".8s" style="animation-delay: 0.8s; animation-name: fadeInUp;">
        <div class="contaier-fluid">
           <div class="row">
              <div class="col-lg-12">
                 <div class="service-cards owl-carousel owl-loaded owl-drag">
                 ...
                 <div class="owl-stage-outer owl-height" style="height: 404px;"><div class="owl-stage" style="transform: translate3d(-1265px, 0px, 0px); transition: all 2s ease 0s; width: 4428px;"><div class="owl-item cloned" style="width: 286.25px; margin-right: 30px;"><div class="service-card-div gradient-3">
                       <a href="#">
                          <div class="service-images"><img src="servicesbox/images/service/design.svg" alt="#"></div>
                          <div class="service-name">Graphic <br> Design </div>
                          <div class="circleffect">
                             <div class="animation">&nbsp;</div>
                          </div>
                       </a>
                    </div></div><div class="owl-item cloned" style="width: 286.25px; margin-right: 30px;"><div class="service-card-div gradient-4">
                       <a href="#">
                          <div class="service-images"><img src="servicesbox/images/service/blockcain.svg" alt="#"></div>
                          <div class="service-name">Blockchain <br> Development </div>
                          <div class="circleffect">
                             <div class="animation">&nbsp;</div>
                          </div>
                       </a>
                    </div></div><div class="owl-item cloned" style="width: 286.25px; margin-right: 30px;"><div class="service-card-div gradient-5">
                       <a href="#">
                          <div class="service-images"><img src="servicesbox/images/service/ecommerce.svg" alt="#"></div>
                          <div class="service-name">Ecommerce <br> Development </div>
                          <div class="circleffect">
                             <div class="animation">&nbsp;</div>
                          </div>
                       </a>
                    </div></div><div class="owl-item cloned" style="width: 286.25px; margin-right: 30px;"><div class="service-card-div gradient-6">
                       <a href="#">
                          <div class="service-images"><img src="servicesbox/images/service/marketing.svg" alt="#"></div>
                          <div class="service-name">Digital <br> Marketing </div>
                          <div class="circleffect">
                             <div class="animation">&nbsp;</div>
                          </div>
                       </a>
                    </div></div><div class="owl-item active" style="width: 286.25px; margin-right: 30px;"><div class="service-card-div gradient-1">
                       <a href="#">
                          <div class="service-images"><img src="servicesbox/images/service/creator-rafiki.svg" alt="#"></div>
                          <div class="service-name">Web <br> Design </div>
                          <div class="circleffect">
                             <div class="animation">&nbsp;</div>
                          </div>
                       </a>
                    </div></div><div class="owl-item active" style="width: 286.25px; margin-right: 30px;"><div class="service-card-div gradient-2">
                       <a href="#">
                          <div class="service-images"><img src="servicesbox/images/service/app.svg" alt="#"></div>
                          <div class="service-name">App <br> Development </div>
                          <div class="circleffect">
                             <div class="animation">&nbsp;</div>
                          </div>
                       </a>
                    </div></div><div class="owl-item active" style="width: 286.25px; margin-right: 30px;"><div class="service-card-div gradient-3">
                       <a href="#">
                          <div class="service-images"><img src="servicesbox/images/service/design.svg" alt="#"></div>
                          <div class="service-name">Graphic <br> Design </div>
                          <div class="circleffect">
                    ...
                    </div></div><div class="owl-item active" style="width: 286.25px; margin-right: 30px;"><div class="service-card-div gradient-4">
                       <a href="#">
                          <div class="service-images"><img src="servicesbox/images/service/blockcain.svg" alt="#"></div>
                          <div class="service-name">Blockchain <br> Development </div>
                          <div class="circleffect">
                    ...
                    </div></div><div class="owl-item" style="width: 286.25px; margin-right: 30px;"><div class="service-card-div gradient-5">
                       <a href="#">
                          <div class="service-images"><img src="servicesbox/images/service/ecommerce.svg" alt="#"></div>
                          <div class="service-name">Ecommerce <br> Development </div>
                          <div class="circleffect">
                    ...
                    </div></div><div class="owl-item" style="width: 286.25px; margin-right: 30px;"><div class="service-card-div gradient-6">
                       <a href="#">
                          <div class="service-images"><img src="servicesbox/images/service/marketing.svg" alt="#"></div>
                          <div class="service-name">Digital <br> Marketing </div>
                          <div class="circleffect">
                    ...
                    </div></div><div class="owl-item cloned" style="width: 286.25px; margin-right: 30px;"><div class="service-card-div gradient-1">
                       <a href="#">
                          <div class="service-images"><img src="servicesbox/images/service/creator-rafiki.svg" alt="#"></div>
                          <div class="service-name">Web <br> Design </div>
                          <div class="circleffect">
                    ...
                    </div></div><div class="owl-item cloned" style="width: 286.25px; margin-right: 30px;"><div class="service-card-div gradient-2">
                       <a href="#">
                          <div class="service-images"><img src="servicesbox/images/service/app.svg" alt="#"></div>
                          <div class="service-name">App <br> Development </div>
                          <div class="circleffect">
                    ...
                    </div></div><div class="owl-item cloned" style="width: 286.25px; margin-right: 30px;"><div class="service-card-div gradient-3">
                       <a href="#">
                          <div class="service-images"><img src="servicesbox/images/service/design.svg" alt="#"></div>
                          <div class="service-name">Graphic <br> Design </div>
                          <div class="circleffect">
...
<footer class="footer">
    <div class="container">
     ...
     <script src="servicesbox/js/jquery.min.js"></script>   
     <script src="servicesbox/js/blueket.plugin.js"></script>  
     <script src="servicesbox/js/custom.js"></script>  

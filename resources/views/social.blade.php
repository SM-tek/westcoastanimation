        ...
        <div style="margin-top:6%;" >
            <div class="dl-container">
                <div class="header-content">
                    <p class="subtitle" style="color: white; font-family: Rany-Bold;">Social Media Marketing-Portfolio</p>
                ...
                <div class="wpo-section-title-s2">
                    <div class="row align-items-center">
                        <div class="col-lg-4 col-12">
                            <div class="title">
                                <h2>Recent Work.</h2>
                                <p>Recent Projects Portfolio Social Media Marketing</p>
                            </div>
                        </div>
                ...
                <div class="wpo-project-wrap wpo-project-slide owl-carousel">
                    <div class="wpo-project-item">
                        <div class="wpo-project-img">
                            <img src="assets1/images/project/creative352.jpg" alt="">
                        </div>
                        <div class="wpo-project-text">
                            <h2><a href="#">Creative Strategy - Social Media Strategy</a></h2>
                            <span>Social Media / Strategy</span>
                        </div>
                    </div>
                    <div class="wpo-project-item">
                        <div class="wpo-project-img">
                            <img src="assets1/images/project/campaigne352.jpg" alt="">
                        </div>
                        <div class="wpo-project-text">
                            <h2><a href="#">Campaigne - Social Media Management</a></h2>
                            <span>Social Media / Management</span>
                        </div>
                    </div>
                    <div class="wpo-project-item">
                        <div class="wpo-project-img">
                            <img src="assets1/images/project/paid352.jpg" alt="">
                        </div>
                        <div class="wpo-project-text">
                            <h2><a href="#">Paid Media - Targeted Management</a></h2>
                            <span>Social Media / Paid Media</span>
                        </div>
                    </div>
                    <div class="wpo-project-item">
                        <div class="wpo-project-img">
